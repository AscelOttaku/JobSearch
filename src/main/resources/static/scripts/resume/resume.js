...
const deleteEducationInfoButton = document.querySelectorAll(".btn.btn-outline-danger.delete-education")

deleteEducationInfoButton.addEventListener("click", (event) => {
    let parentBlock = event.currentTarget.parentElement.parentElement
    console.log(parentBlock)
